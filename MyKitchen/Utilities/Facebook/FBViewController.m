...
- (void)feed{
	...
	NSMutableDictionary* params = [NSMutableDictionary dictionaryWithObjectsAndKeys:
								   FBAppID, @"app_id",
								   kApplink, @"link",
								   @"http://www.xappsoft.de/img/icon_Tinykitchen_200.jpg", @"picture",
								   @"Tiny Kitchen", @"name",
								   @"Amazing iPhone/iPad App for little kids", @"caption",
								   @"Tiny Kitchen is a cooking app for tiny cooks :-)  Young children can play kitchen on iPhone or iPad now. Hundred foods and realistic kitchen appliances for four cute characters. Cook and discover what they favor. Cooking will be a truly enjoyable activity for your children.", @"description",
								   nil];
